BWL.Services.CartService = {
	...
	AddAddressAsync : function (storeKey, addressKey, successCallback,
			errorCallback) {
		var uri = '<%= at.urlApi %>/cart.svc/{0}/{1}'.format(storeKey,
				addressKey);
		BWL.InvokeService('PUT', uri, null, successCallback, errorCallback);
	},
...
BWL.Services.DownloadService = {
	DownloadFileAsync : function (storeKey, itemType, itemKey, successCallback,
			errorCallback) {
		var uri = '<%= at.urlApi %>/download.svc/{0}/file/{1}/{2}'.format(
				storeKey, itemType, itemKey);
		BWL.InvokeService('GET', uri, null, successCallback, errorCallback);
	},
...
BWL.Services.InventoryService = {
	AddInventoryItemsAsync : function (storeKey, type, key, quantity,
			successCallback, errorCallback) {
		var uri = '<%= at.urlApi %>/inventory.svc/{0}/{1}/{2}/{3}'.format(
				storeKey, type, key, quantity);
		BWL.InvokeService('PUT', uri, null, successCallback, errorCallback);
	},
...
BWL.Services.MediaLibraryService = {
	CropResizeImageAsync : function (storeKey, key, objImageCropResize,
			successCallback, errorCallback) {
		var uri = '<%= at.urlApi %>/medialibrary.svc/{0}/image/crop/{1}'
	...
	ListImagesAsync : function (storeKey, successCallback, errorCallback) {
		var uri = '<%= at.urlApi %>/medialibrary.svc/{0}/images'
				.format(storeKey);
		BWL.InvokeService('GET', uri, null, successCallback, errorCallback);
	},
	...
	ListFilesAsync : function (storeKey, successCallback, errorCallback) {
		var uri = '<%= at.urlApi %>/medialibrary.svc/{0}/files'
				.format(storeKey);
		BWL.InvokeService('GET', uri, null, successCallback, errorCallback);
	},
	DeleteFileAsync : function (storeKey, key, successCallback, errorCallback) {
		var uri = '<%= at.urlApi %>/medialibrary.svc/{0}/file/{1}'.format(
				storeKey, key);
		BWL.InvokeService('DELETE', uri, null, successCallback, errorCallback);
	}
};
BWL.Services.MembershipService = {
	RegisterAsync : function (storeKey, objMembership, successCallback,
			errorCallback) {
		var uri = '<%= at.urlApi %>/membership.svc/{0}/register'.format(
	...
	ResetPasswordAsync : function (storeKey, objMembership, successCallback,
			errorCallback) {
		var uri = '<%= at.urlApi %>/membership.svc/{0}/resetpass'.format(
				storeKey, objMembership);
		BWL.InvokeService('POST', uri, objMembership, successCallback,
				errorCallback);
	},
...
BWL.Services.MessageService = {
	GetMessagesProvidersAsync : function (successCallback, errorCallback) {
		BWL.InvokeService('GET', '<%= at.urlApi %>/message.svc/providers',
	...
	SendStoreAdminMessageAsync : function (storeKey, objMessage,
			successCallback, errorCallback) {
		var uri = '<%= at.urlApi %>/message.svc/{0}/storeadmin'.format(
				storeKey, objMessage);
		BWL.InvokeService('POST', uri, objMessage, successCallback,
				errorCallback);
	},
...
BWL.Services.ModelService = {
	CreateAsync : function (storeKey, type, obj, successCallback, errorCallback) {
		var uri = '<%= at.urlApi %>/model.svc/{0}/{1}'.format(storeKey, type,
				obj);
	...
	UpdateAsync : function (storeKey, type, key, obj, successCallback,
			errorCallback) {
		var uri = '<%= at.urlApi %>/model.svc/{0}/{1}/{2}'.format(storeKey,
				type, key, obj);
	...
	AddAsync : function (storeKey, type, key, property, addType, addObject,
			successCallback, errorCallback) {
		var uri = '<%= at.urlApi %>/model.svc/{0}/{1}/{2}/{3}/{4}'.format(
				storeKey, type, key, property, addType, addObject);
		BWL
	...
	GetAsync : function (storeKey, type, key, property, levels,
			successCallback, errorCallback) {
		var uri = '<%= at.urlApi %>/model.svc/{0}/{1}/{2}/{3}/{4}'.format(
				storeKey, type, key, property, levels);
		BWL.InvokeService('GET', uri, null, successCallback, errorCallback);
	},
	...
	ListAsync : function (storeKey, type, page, successCallback, errorCallback) {
		var uri = '<%= at.urlApi %>/model.svc/{0}/{1}?p={2}'.format(storeKey,
				type, page);
		BWL.InvokeService('GET', uri, null, successCallback, errorCallback);
	},
	FindAsync : function (storeKey, type, page, obj, successCallback,
			errorCallback) {
		var uri = '<%= at.urlApi %>/model.svc/{0}/find/{1}?p={2}'.format(
				storeKey, type, page, obj);
		BWL.InvokeService('POST', uri, obj, successCallback, errorCallback);
	},
...
BWL.Services.oAuthService = {
	...
	GetSessionStateAsync : function (sessionKey, successCallback, errorCallback) {
		var uri = '<%= at.urlApi %>/oauth.svc/sessionState/{0}'
				.format(sessionKey);
		BWL.InvokeService('GET', uri, null, successCallback, errorCallback);
	},
...
BWL.Services.PaymentService = {
	...
	FindProviderInfoByTypeAsync : function (providerType, successCallback,
			errorCallback) {
		var uri = '<%= at.urlApi %>/payment.svc/provider/{0}'
				.format(providerType);
		BWL.InvokeService('GET', uri, null, successCallback, errorCallback);
	},
...
BWL.Services.RootService = {
	...
	GetJavaScriptProxiesMetaAsync : function (successCallback, errorCallback) {
		BWL.InvokeService('GET', '<%= at.urlApi %>/root.svc/servicesmeta.js',
				null, successCallback, errorCallback);
	},
	...
	GetJavaScriptModelMetaAsync : function (successCallback, errorCallback) {
		BWL.InvokeService('GET', '<%= at.urlApi %>/root.svc/modelsmeta.js',
				null, successCallback, errorCallback);
	},
	GetJavaScriptModelEnumAsync : function (successCallback, errorCallback) {
		BWL.InvokeService('GET', '<%= at.urlApi %>/root.svc/modelsenum.js',
				null, successCallback, errorCallback);
	},
	GetJavaScriptModelEmberAsync : function (successCallback, errorCallback) {
		BWL.InvokeService('GET', '<%= at.urlApi %>/root.svc/modelember.js',
				null, successCallback, errorCallback);
	},
	...
	InitializeInfoAsync : function (successCallback, errorCallback) {
		BWL.InvokeService('GET', '<%= at.urlApi %>/root.svc/initializeinfo',
				null, successCallback, errorCallback);
	},
	InitializeGEOAsync : function (successCallback, errorCallback) {
		BWL.InvokeService('GET', '<%= at.urlApi %>/root.svc/initializegeo',
				null, successCallback, errorCallback);
	}
};
BWL.Services.ScannerService = {
	ListDevicesAsync : function (storeKey, levels, successCallback,
			errorCallback) {
		var uri = '<%= at.urlApi %>/scanner.svc/{0}/{1}'.format(storeKey,
				levels);
		BWL.InvokeService('GET', uri, null, successCallback, errorCallback);
	},
	RegisterDeviceAsync : function (storeKey, deviceKey, objDeviceInfo,
			successCallback, errorCallback) {
		var uri = '<%= at.urlApi %>/scanner.svc/{0}/register/{1}'.format(
				storeKey, deviceKey, objDeviceInfo);
		BWL.InvokeService('PUT', uri, objDeviceInfo, successCallback,
				errorCallback);
	},
	GetConfigAsync : function (storeKey, deviceKey, successCallback,
			errorCallback) {
		var uri = '<%= at.urlApi %>/scanner.svc/{0}/config/{1}'.format(
				storeKey, deviceKey);
		BWL.InvokeService('GET', uri, null, successCallback, errorCallback);
	},
...
BWL.Services.SearchIndexService = {
	...
	SearchTagsAsync : function (searchString, orderBy, page, successCallback,
			errorCallback) {
		var uri = '<%= at.urlApi %>/searchindex.svc/tags?q={0}&o={1}&p={2}'
				.format(searchString, orderBy, page);
		BWL.InvokeService('GET', uri, null, successCallback, errorCallback);
	},
...
BWL.Services.SystemProfileService = {
	...
	SignupAsync : function (successCallback, errorCallback) {
		BWL.InvokeService('GET', '<%= at.urlApi %>/systemprofile.svc/signup',
				null, successCallback, errorCallback);
	},
	...
	VerifyEmailAsync : function (email, approveToken, successCallback,
			errorCallback) {
		var uri = '<%= at.urlApi %>/systemprofile.svc/verify/{1}?email={0}'
				.format(email, approveToken);
		BWL.InvokeService('GET', uri, null, successCallback, errorCallback);
	},
	...
	LogoffAsync : function (successCallback, errorCallback) {
		BWL.InvokeService('GET', '<%= at.urlApi %>/systemprofile.svc/logoff',
				null, successCallback, errorCallback);
	},
	...
	ResetPasswordAsync : function (objAccount, successCallback, errorCallback) {
		var uri = '<%= at.urlApi %>/systemprofile.svc/resetpass'
				.format(objAccount);
		BWL.InvokeService('POST', uri, objAccount, successCallback,
				errorCallback);
	},
