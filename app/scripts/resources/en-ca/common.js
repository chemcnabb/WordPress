...
var CommonResources = {
    ...
    Text_State: ['Currently Public, Make Private', 'Currently Private, Make Public', '(Private)', '(Public)'],
    Text_Status: 'Status',
    ...
    Text_AddRemoveInventoryItemTitlePopup: ['Add Inventory Items', 'Remove Inventory Items'],
