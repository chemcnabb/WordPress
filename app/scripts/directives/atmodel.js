 ...
 */
azureTicketsApp.directive('atmodel', [
    '$compile',
    '$filter',
    'objectService',
    function($compile, $filter, objectService) {
      ...
      return {
        ...
        link : function($scope, $element, $attrs) {
          var out = {}, resPrefix = 'Common.Label' + $scope.atModel.Type;
          ...
          for (p in $scope.atModel) {
            ...
            if (angular.isString(pp) && pp !== '' && [
            ...
            } else if (angular.isString(pp) && p === BWL.Model.Currency.Type) {
              ...
              switch (pp.Type) {
                case BWL.Model.Address.Type:
                  ...
                  var c = objectService.grep(countries, 'ISO', pp.Country);
