        ...
        function($q, $rootScope, $cookieStore, modelService, configService,
          ...
          return {
            ...
            initPlace : function(storeKey, placeKey) {
              ...
              BWL.Services.ModelService.ReadAsync(storeKey, "Place", placeKey,
                  10, function(place) {
            ...
            deletePlace : function(storeKey, event) {
              ...
              BWL.Services.ModelService.DeleteAsync(storeKey,
                  this.getEvent().Type, event.Key, function() {
                    $rootScope.$apply(function() {
                      def.resolve()
                    });
                  }, function(err) {
            ...
            addPlaceAddress : function(placeKey, address) {
              ...
              BWL.Services.ModelService.CreateAsync(placeKey, "Address",
                  address, function(addressKey) {
                    BWL.Services.ModelService.AddAsync(placeKey, "Place",
                        placeKey, "Address", "Address", addressKey, function(
                            ret) {
            ...
            updatePlace : function(storeKey, place) {
              ...
              BWL.Services.ModelService.UpdateAsync(storeKey, 'Place',
            ...
            /**
             * To be used from any controller, so it updates the $scope.venues
