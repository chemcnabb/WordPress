                        ...
                        function($q, $rootScope, modelService) {
                            ...
                            return {
                                listStoresAsync : function(levels) {
                                    ...
                                    BWL.Services.StoreService.ListStoresAsync(
                                            levels, function(stores) {
                                                _stores = stores;
                                ...
                                initStore : function(storeKey) {
                                    ...
                                    BWL.Services.ModelService
                                            .ReadAsync(
                                                    ...
                                                    function(store) {
                                                        if (!angular
                                                                .isDefined(store.Address)){store.Address = modelService
